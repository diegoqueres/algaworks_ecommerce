...
insert into cliente (id, nome) values (1, 'Marcio Albuquerque');
insert into cliente (id, nome) values (2, 'Thomas Epaminondas');
...
insert into pagamento_cartao (pedido_id, status, tipo_pagamento, numero_cartao) values (2, 'PROCESSANDO', 'cartao', '5308280517032328');
